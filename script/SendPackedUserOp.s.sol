...
contract SendPackedUserOp is Script {
    ...
    function run() public {
        ...
        bytes memory functionData = abi.encodeWithSelector(
            ...
            0x7E12D9EC7245A21ffe6908E91b87Ba414D56bd72,
            1e18
        );
        bytes memory execeuteCallData = abi.encodeWithSelector(MinimalAccount.execute.selector, dest, value functionData);
        PackedUserOperation memory userOp = generatedSignedUserOperation(execeuteCallData, helperConfig.getConfig(), address(MinimalAccount));
