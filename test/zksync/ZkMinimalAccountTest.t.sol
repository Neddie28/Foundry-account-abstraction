...
import {BOOTLOADER_FORMAL_ADDRESS} from "lib/foundry-era-contracts/system-contracts/contracts/Constants.sol";
...
contract ZkMinimalAccountTest is Test {
    ...
    function testZkValidateTransaction() public {
        ...
        address dest = address(usdc);
        uint256 value = 0;
        bytes memory functionData = abi.encodeWithSelector(ERC20Mock.mint.selector, address(zkMinimalAccount),
        AMOUNT),
    ...
    /* ////////////////////////////////////////////////////////////////////////////
                                    HELPERS
    /////////////////////////////////////////////////////////////////////////////*/
    function _signTransaction(Transaction memory transaction) internal view return(Transaction memory) {
    ...
    function _createUnsignedTransaction(address from, uint8 transactionType, address to, uint256 value, bytes memory data ) internal view returns(Transaction memory) {
        ...
        return Transaction({
            txType: transactionType, // Type 113 (ox71).
